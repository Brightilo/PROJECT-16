...
* Add the following block of code to create two VPC subnets   # Create public subnets1
...
* terraform apply
*  
* Destroy the current infrastructure with terraform destroy
...
* Adding the following block to the main.tf file   variable "region" {
